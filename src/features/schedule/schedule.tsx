...
const Schedule = () => {
  return (
    <div className="relative grid w-min min-w-full grid-cols-[3rem_repeat(7,minmax(9.375rem,1fr))_1rem] grid-rows-[min-content_repeat(32,2rem)_1rem] gap-[var(--gap)] [--gap:0.3125rem] max-md:pb-14">
      <PastDays />
